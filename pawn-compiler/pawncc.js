...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5305472,
    DYNAMIC_BASE = 5305472,
    DYNAMICTOP_PTR = 62336;
...
var wasmBinaryFile = 'pawncc.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=62384;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=62432;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 62480, 4), 62480);
...
var real__pc_compile = asm["_pc_compile"]; asm["_pc_compile"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__pc_compile.apply(null, arguments);
};
...
var _pc_compile = Module["_pc_compile"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_pc_compile"].apply(null, arguments) };
